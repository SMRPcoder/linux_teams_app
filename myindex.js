...
function createWindow() {
  ...
  function flashTray() {
    ...
    const defaultIcon = nativeImage.createFromPath(path.join(__dirname, 'icon.png'));
    const altIcon = nativeImage.createFromPath(path.join(__dirname, 'icon-alt.png')); // Optional alternate icon
